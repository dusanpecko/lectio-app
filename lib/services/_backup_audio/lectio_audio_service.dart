...
class LectioAudioHandler extends BaseAudioHandler
  ...
  Future<void> _configureAudioSession() async {
    try {
      // CRITICAL: Configure audio session for Android background playback
      // This tells the OS our app is a media player and needs audio focus
      final session = await AudioSession.instance;
      await session.configure(const AudioSessionConfiguration.speech());
      await session.setActive(true);
      _logger.i('🎵 AudioSession configured and activated');
